...
public class InputStreamWrapper {
    ...
    public short readShortLE() throws IOException {
        return LmIO.reverseBytesShort(readShort());
    }
    ...
    public int readIntLE() throws IOException {
        return LmIO.reverseBytesInt(readInt());
    }
    ...
    public long readLongLE() throws IOException {
        return LmIO.reverseBytesLong(readLong());
    }
    ...
    public long indexOf(byte content, long startIndex) throws IOException {
        long resultIndex;
        while ((resultIndex = findInBuffer(content, startIndex)) == -1L) {
            startIndex = size;
            if (read(IOBuffer.BUFFER_SIZE) == -1L) return -1L;
        }
        return resultIndex;
    }
